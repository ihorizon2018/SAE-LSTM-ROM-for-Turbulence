...
def cc(ori_data, rom_data_0, rom_data_1, rom_data_2, rom_data_3,rom_data_4, rom_data_5,rom_data_6,rom_data_7,y_axis_min,fieldName,startNumber,n):
...
# draw the plot for correlation coefficient
    ...
    if ori_data.ndim == rom_data_0.ndim:
        if rom_data_0.ndim == 3:
            ...
            fig.dpi=200
            ax0 = fig.add_subplot()
            ax0.set_prop_cycle(color = ['#f6b93b','#f6b93b','#FF3030','#FF3030','purple','purple','#000000','#000000'], linestyle = ['solid', 'dashed','-', '--', '-', '--', '-', '--'])
            plt.ylim((0, 1.001))
            ...
            if fieldName == 'Velocity':
                ...
                ax0.plot(x, y_0, x, y_1, x, y_2, x, y_3,x, y_4, x, y_5, x, y_6, x, y_7,linewidth=1.5)
                plt.legend(['Sequence Length l=10','Sequence Length l=20', 'Sequence Length l=30','Sequence Length l=40','Sequence Length l=50','Sequence Length l=60','Sequence Length l=70','Sequence Length l=80'], loc='lower right',fontsize=15,ncol=n)
...
def rmse_over_time(ori_data, rom_data_0, rom_data_1, rom_data_2, rom_data_3,rom_data_4, rom_data_5, rom_data_6, rom_data_7,fieldName, maxValue, startNumber,n):
    if fieldName == 'Velocity':
        ...
        #print(x)
        ax0.set_prop_cycle(color = ['#f6b93b','#f6b93b','#FF3030','#FF3030','purple','purple','#000000','#000000'], linestyle = ['-', '--','-', '--', '-', '--', '-', '--'])
        ...
        ax0.plot(x, y_0, x, y_1, x, y_2, x, y_3,x, y_4, x, y_5,x, y_6, x, y_7,linewidth=1.5)
        plt.legend(['Sequence Length l=10','Sequence Length l=20', 'Sequence Length l=30','Sequence Length l=40','Sequence Length l=50','Sequence Length l=60','Sequence Length l=70','Sequence Length l=80'], loc='upper left',fontsize=14,ncol=n)
        plt.show()
    elif fieldName == 'U':
        #point = [0,rom_data_0.shape[0]]
        #point = [2800,3250]
        ...
        y_6 = moving_average(rmse_6, number)[int(number/2)+1:rmse_0.shape[0]-int(number/2)]
        y_7 = moving_average(rmse_7, number)[int(number/2)+1:rmse_0.shape[0]-int(number/2)]
        ...
        plt.legend(['Sequence Length l=10','Sequence Length l=20', 'Sequence Length l=30','Sequence Length l=40','Sequence Length l=50','Sequence Length l=60','Sequence Length l=70','Sequence Length l=80'], loc='upper left',fontsize=15,ncol=n)
        plt.show()
...
def cc9(ori_data, rom_data_0, rom_data_1, rom_data_2, rom_data_3,rom_data_4, rom_data_5,rom_data_6, rom_data_7,y_axis_min,fieldName,startNumber,n):
    if ori_data.ndim == rom_data_0.ndim:
        if rom_data_0.ndim == 3:
            ...
            predicted4 = np.transpose(rom_data_3)   # 
            predicted5 = np.transpose(rom_data_4)  # 
            predicted6 = np.transpose(rom_data_5)  # 
            predicted7 = np.transpose(rom_data_6)  # 
            predicted8 = np.transpose(rom_data_7)  # 
            ...
            for t in range(time_series_length):
                ...
                corr7 = np.corrcoef(original[:, t], predicted7[:, t])[0, 1]
                corr8 = np.corrcoef(original[:, t], predicted8[:, t])[0, 1]
                ...
                corrs_pred7.append(corr7)
                corrs_pred8.append(corr8)
            ...
            corrs_pred7 = np.array(corrs_pred7)
            corrs_pred8 = np.array(corrs_pred8)
            ...
            corrs_pred7 = replace_inf_with_nan(corrs_pred7)
            corrs_pred8 = replace_inf_with_nan(corrs_pred8)
            ...
            corrs_pred7 = interpolate_nan(corrs_pred7)
            corrs_pred8 = interpolate_nan(corrs_pred8)
            ...
            if fieldName == 'Velocity':
                ...
                y_6 = moving_average_2(corrs_pred7,windowsize)[int(windowsize/2)+1:ori_data.shape[0]-int(windowsize/2)]
                y_7 = moving_average_2(corrs_pred8,windowsize)[int(windowsize/2)+1:ori_data.shape[0]-int(windowsize/2)]
                x = np.linspace(startNumber+0, startNumber+(ori_data.shape[0]-windowsize) / rate, ori_data.shape[0]-windowsize)[3:]
                #x = np.linspace(startNumber+0,startNumber+ori_data.shape[0]/rate,ori_data.shape[0])
                plt.ylim((y_axis_min, 1.001))
                
                plt.xlabel('Time(s)',{'size' : 15})
                ax0.plot(x, y_0, x, y_1, x, y_2, x, y_3, x, y_4, x, y_5,x,y_6,x,y_7)
                plt.legend(['Sequence Length l=10','Sequence Length l=20', 'Sequence Length l=30','Sequence Length l=40','Sequence Length l=50','Sequence Length l=60','Sequence Length l=70','Sequence Length l=80'], loc='lower left',fontsize=15,ncol=n)
            plt.show()
    else:
        print('the dimension of these two series are not equal. Please check them.')
