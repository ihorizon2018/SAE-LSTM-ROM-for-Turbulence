...
def cc(ori_data, rom_data_0, rom_data_1,y_axis_min,fieldName,startNumber):
    ...
    if ori_data.ndim == rom_data_0.ndim:
        if rom_data_0.ndim == 3:
            ...
            if fieldName == 'Velocity':
                ...
                ax0.plot(x, y_0, x, y_1,linewidth=1.5)
                plt.legend(['SAE-LSTM', 'SAE-DMD'], loc='lower right',fontsize=15)
...
def point_over_time(ori_data, rom_data_0, rom_data_1, rom_data_2, pointNo, fieldName):
 # rom_data_2, rom_data_4, rom_data_5, pointNo, fieldName):# 1: full model; 2: ROM model
    ...
    if fieldName == 'Velocity': # flow_past_cylinder
        ...
        ax0.set_prop_cycle(color = ['#2f3542','#BF3EFF','#FF3030','#104E8B','#8DEEEE'], linestyle = [':','--', ':', '--', '--'])
        # ax0.plot(x, y, x, y_0, x, y_1, x, y_2, x, y_3, linewidth = 0.8)
        ax0.plot(x, y, x, y_0, x, y_1, x, y_2)
        ...
        plt.legend(['Full Model', 'DMD', 'SAE-DMD', 'AE+PIM'], loc='lower right')
        ...
        plt.legend(['Full Model', 'DMD', 'SAE-DMD m=50', 'SAE-DMD m=40', 'SAE-DMD m=30'], loc='upper left')
...
def rmse_over_time(ori_data, rom_data_0, rom_data_1,fieldName,maxValue,startNumber):
    if fieldName == 'Velocity':
        ...
        # plt.title('Correlation Coefficient')
        ax.plot(x, y_0, x, y_1,linewidth=1.5)
        ...
        plt.legend(['SAE-LSTM', 'SAE-DMD'], loc='upper left',fontsize=15)
        plt.show()
    elif fieldName == 'U':
        point = [0,ori_data.shape[0]]
        #point = [2800,3250]
        ...
        plt.legend(['SAE-LSTM', 'SAE-DMD'], loc='upper right',fontsize=15)
        plt.show()
