    ...
    if ori_data.ndim == rom_data_0.ndim:
        if rom_data_0.ndim == 3:
            ...
            if fieldName == 'Velocity':
                ...
                plt.legend(['SAE m=5','POD m=5', 'SAE m=10','POD m=10','SAE m=45','POD m=45'], loc='lower left',fontsize=15,ncol=3)
    ...
    if ori_data.ndim == rom_data_0.ndim:
        if rom_data_0.ndim == 3:
            ...
            if fieldName == 'Velocity':
                ...
                ax0.plot(x, y_0, x, y_1, x, y_2, x, y_3,x, y_4, x, y_5,linewidth=1.5)
                plt.legend(['SAE m=5','POD m=5', 'SAE m=10','POD m=10','SAE m=45','POD m=45'], loc='lower right',fontsize=15,ncol=3)
...
def rmse_over_time(ori_data, rom_data_0, rom_data_1, rom_data_2, rom_data_3,rom_data_4, rom_data_5, fieldName, maxValue, startNumber):
    if fieldName == 'Velocity':
        ...
        ax0.plot(x, y_0, x, y_1, x, y_2, x, y_3,x, y_4, x, y_5,linewidth=1.5)
        plt.legend(['SAE m=5','POD m=5', 'SAE m=10','POD m=10','SAE m=45','POD m=45'], loc='upper left',fontsize=14,ncol=3)
        plt.show()
    elif fieldName == 'U':
        #point = [0,rom_data_0.shape[0]]
        #point = [2800,3250]
